...
class TestParameters(unittest.TestCase):
    ...
    def test_not_all_required(self):
        ...
        try:
            mr.Parameters(root=r"tests\data\tuflow\one_tcf")
    ...
    def test_get_executable(self):
        # Test basic creation
        p: mr.Parameters = mr.Parameters(
            exec_path=r"tests\data\tuflow\executables",
    ...
    def test_group_id(self):
        ...
        self.assertEqual(
            p._find_tcfs(),
            [
                os.path.realpath(r"tests\data\tuflow\group_tcf\MY_PRJ_~s1~_~e1~_~e2~_~e3~_01.tcf"),
        ...
        self.assertEqual(
            p._find_tcfs(), [os.path.realpath(r"tests\data\tuflow\group_tcf\THERE_PRJ_~s1~_~e1~_~e2~.tcf")]
        )
...
class TestRunner(unittest.TestCase):
    ...
    def test_build_command(self):
        ...
        test_tokens = [
            os.path.realpath(r"tests\data\tuflow\executables\2020-10-AD\TUFLOW_iDP_w64.exe"),
            "-b",
            "-s1",
            "1",
            "-e1",
    ...
    def test_real(self):
        p: mr.Parameters = mr.Parameters(
            exec_path=r"C:\Program Files\TUFLOW", root=r"tests\data\tuflow\one_tcf", version=r"2020-10-AD", engine=r"DP"
        )
